 ...
 * @author CARITO
 */
public class EliminarEspeciales extends javax.swing.JFrame {

    /**
     * Creates new form EliminarEspeciales
     */
    public EliminarEspeciales() {
        initComponents();
    }
    ...
    private void EliminarbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarbtnActionPerformed
        ...
        f.eliminar(id,"descripcion_especiales","id_examen");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarEspeciales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarEspeciales().setVisible(true);
            }
        });
    }
