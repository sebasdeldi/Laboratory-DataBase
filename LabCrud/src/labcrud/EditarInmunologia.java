 ...
 * @author CARITO
 */
public class EditarInmunologia extends javax.swing.JFrame {

    /**
     * Creates new form EditarEspeciales
     */
    public EditarInmunologia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarInmunologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarInmunologia().setVisible(true);
            }
        });
    }
