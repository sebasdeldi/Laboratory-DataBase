 ...
 * @author CARITO
 */
public class EliminarQuimicas extends javax.swing.JFrame {

    /**
     * Creates new form EliminarEspeciales
     */
    public EliminarQuimicas() {
        initComponents();
    }
    ...
    private void EliminarbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarbtnActionPerformed
        ...
        f.eliminar(id,"descripcion_quimicas","id_examen");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarQuimicas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarQuimicas().setVisible(true);
            }
        });
    }
