 ...
 * @author CARITO
 */
public class EditarHematologia extends javax.swing.JFrame {

    /**
     * Creates new form EditarEspeciales
     */
    public EditarHematologia() {
        initComponents();
    }
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        f.editar("UPDATE descripcion_hematologia\n" +
            "SET valor= "+valor+"\n" +
            "WHERE id_examen= "+id+";", "descripcion_hematologia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarHematologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarHematologia().setVisible(true);
            }
        });
    }
