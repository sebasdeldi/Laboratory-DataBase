 ...
 * @author CARITO
 */
public class AgregarHematologia extends javax.swing.JFrame {

    /**
     * Creates new form AgregarEspeciales
     */
    public AgregarHematologia() {
        initComponents();
    }
    ...
    private void AgregarInventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarInventarioActionPerformed
        ...
        String insert = "insert into descripcion_hematologia (id_examen,nombre_examen,valor)\n" +
        "value("+id+","+f.agregarComillas(nombre)+","+valor+");";
        
        f.agregar(insert, "descripcion_hematologia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarHematologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarHematologia().setVisible(true);
            }
        });
    }
